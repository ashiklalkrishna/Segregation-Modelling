...
to go
  ...
  set previous-unhappy percent-unhappy
  ...
  ;; check convergence:
  ifelse abs (percent-unhappy - previous-unhappy) < 0.5 [
  ...
  ;; stop if system hasn’t changed much for many ticks
  if stable-ticks > 5 [ stop ]
